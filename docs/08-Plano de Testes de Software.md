...
| Passos 	| -  Acessar o aplicativo <br> Acessar página de Login<br> - Informar número de telefone e senha <br> - Acessar a área do administrador  |
-Clicar no símbolo em "Alterar informações do estabelecimento"|
...
| Passos 	| - Acessar o aplicativo <br> - Visualizar a página principal<br> Acessar página de Login<br> - <br> - clicar no botão SAC. |
