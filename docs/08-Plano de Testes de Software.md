...
| Objetivos do Teste 	| Verificar se o sistema disponibiliza o cadastro, se a validação está ocorrendo, assim como o login caso o usuário já tenha se cadastro|
