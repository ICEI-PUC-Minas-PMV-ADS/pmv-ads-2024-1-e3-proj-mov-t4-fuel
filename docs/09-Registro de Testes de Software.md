...
|Resultado Obtido | -A aplicação confirma o cadastro de novos usuários assim que os dados requisitados foram validados.<br>|
...
|Resultado Obtido | -A aplicação exibe uma lista de estabelecimentos<br> 
